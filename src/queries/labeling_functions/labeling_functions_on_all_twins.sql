drop table if exists general.same_year_lf_twins_pairs;

create table
general.same_year_lf_twins_pairs
as
select
...
drop table if exists general.same_year_lf_twins_pairs_stats;

create table
general.same_year_lf_twins_pairs_stats
as
select
count(*) as cases
...
drop table if exists general.same_year_lf_twins_pairs_stats_by_age_group;

create table
general.same_year_lf_twins_pairs_stats_by_age_group
as
select
count(*) as cases
, count(distinct author_email) as developers
...
drop table if exists general.same_year_lf_twins_pairs_stats_by_language_code;

create table
general.same_year_lf_twins_pairs_stats_by_language_code
as
select
count(*) as cases
, count(distinct author_email) as developers
...
drop table if exists general.same_year_lf_twins_pairs_stats_by_Is_Company;

create table
general.same_year_lf_twins_pairs_stats_by_Is_Company
as
select
count(*) as cases
, count(distinct author_email) as developers
...
drop table if exists general.same_year_lf_twins_pairs_stats_by_dev_group;

create table
general.same_year_lf_twins_pairs_stats_by_dev_group
as
select
count(*) as cases
, count(distinct author_email) as developers
...
drop table if exists general.same_year_lf_twins_pairs_stats_by_popularity_group;

create table
general.same_year_lf_twins_pairs_stats_by_popularity_group
as
select
count(*) as cases
, count(distinct author_email) as developers
